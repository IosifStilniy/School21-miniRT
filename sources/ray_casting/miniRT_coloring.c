...
// /*   Updated: 2022/06/30 18:31:35 by dcelsa           ###   ########.fr       */
// /*                                                                            */
// /* ************************************************************************** */
...
// 			mltvec = ft_multiply_vector(&ray.dir, dist[1] + 0.0001f);
// 			phit = ft_summ_vectors(&mltvec, &ray.orig);
...
// t_ui	ft_shadowing(t_cart *phit, t_cart *object_norm, t_cart *object_color,
// 		t_info *info)
// {
// 	t_cart	n_vect[4];
// 	t_cart	mltvec;
...
// 	mltvec = ft_multiply_vector(&n_vect[2], 2 * ft_get_dot_product(&n_vect[1], &n_vect[2]));
// 	n_vect[3] = ft_substract_vectors(&mltvec, &n_vect[1]);
