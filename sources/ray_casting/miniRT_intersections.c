...
/*   Updated: 2022/06/09 22:11:19 by ncarob           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	norm_vector = ft_get_vector_norm(plane->vector,
// 			ft_get_vector_length(plane->vector));
// 	division = ft_get_dot_product(ray_dir, norm_vector);
// 	if (!division)
// 		return (INFINITY);
// 	new_plane_pos = ft_substract_vectors(ray_orig, plane->position);
